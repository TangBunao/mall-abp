...
{
    public partial class CreatedProductCategoryEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductUnit = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    NavStatus = table.Column<int>(type: "int", maxLength: 1, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PmsProductCategory", x => x.Id);
                });
